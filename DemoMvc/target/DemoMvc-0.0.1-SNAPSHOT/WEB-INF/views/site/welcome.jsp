...
$(document).ready(function(){
	...
	$('#sent').click(function(e){
		...
		var  jdata={"name":"aravind","degree":"MCA"};
    ...
    <div class="panel-heading">	
                        ...
                        <div class="col-sm-7"></div>
                         ...
                         <div class="col-sm-3">
						   ...
						   <div class="col-sm-2">
                                 <input type="submit" name="action" value="search"  id="find"  class="btn btn-info" />
	               ...
	               <input type="submit" name="action" value="save"  class="btn btn-info"/>
	                   <input type="submit" name="action" value="update"  class="btn btn-info"/>
	                    <input type="submit" name="action" value="delete"  class="btn btn-info"/>
	                          ...
	                          <input type="submit" name="action" value="sent"  id="sent"  class="btn btn-info" />
